...
<html>
  <head>
    ...
    <title><?php echo "PPDB - UNIVERSITAS PELITA BANGSA"; ?></title>
  </head>
    ...
    <div class="col-md-6">
      ...
      <form class="login-form" method="post" action="<?php echo base_url('auth/aksi_tambah'); ?>">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" required name="kampus" placeholder="Asal Sekolah" autofocus>
        </div>
        ...
        <div class="form-group">
          <label class="control-label">Program Peminatan</label>
