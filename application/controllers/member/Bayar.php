...
class Bayar extends CI_Controller {
	...
	function aksi_upload(){
		...
		$this->session->set_flashdata('bukti', '<div class="alert alert-success" role="alert">Terimakasih, Bukti pembayaran berhasil diupload! Mohon tunggu verifikasi dari kami</div>');
