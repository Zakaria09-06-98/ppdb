...
//index pertama di akses, tapi ada kondisi (jika sudah login) if login !=true
	function index() {
		if ($this->session->login != true) {
			//posisi view login, ada di folder views/auth/login.php (tanpa ditulis .php)
...
//akses login karena durung login 
	function login() {
